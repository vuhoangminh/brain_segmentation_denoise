...
if is_laptop
    path = 'C:\Users\minhm\Documents\GitHub\3DUnetCNN_BRATS\projects\idrid\database';
    dir = rdir([path, '\**\*.*']);
else
    path = '/home/minhvu/github//3DUnetCNN_BRATS/projects/idrid/database';
    dir = rdir([path, '/**/*.*']);
end
...
% for i=1:size(dir,1)
    ...
    elseif contains(dir(i).name, "denoised") || isfolder(dir(i).name)
        ...
        if contains(dir(i).name, "img.png") 
