...
V = niftiread('flair.nii.gz');
z = V;
% perform filtering
tic
disp('Denoising started')

[y_est_predefined, sigma_est] = bm4d(z, distribution, (~estimate_sigma)*sigma, profile, do_wiener, verbose);
toc
...
figure, 
imshow3D(y_est_predefined);

figure, 
imshow3D(y_est_auto);

save denoised.mat z y_est_predefined y_est_auto